...
# }
# 
# saveRDS(risk_matrix_XB, "./output/3d_risk_matrix_XB.RDS")
...
# }
# saveRDS(risk_matrix_excludeXB, "./output/3d_risk_matrix_excludeXB.RDS")
...
ggsave("output/figs/trajectory_56_vs_250.png",
       plot,
       width = 4.6,
       height = 4.5,
       units = "in"
...
p_bottom <- ggplot(dt_long_risk_matrix_sm[outcome!="None"], aes(x=time_to_fu, y=Risk))+
  ...
  scale_color_manual(values=c("grey", "red2", "springgreen4", "darkorange3"), name="Example trajectories")+
  scale_alpha_manual(values=c(0.4, 1, 1, 1), name="Example trajectories")+
  scale_size_manual(values=c(0.2, 1, 1, 1), name="Example trajectories")+
